			...
			<div class="span8 offset2">
				<div class="tabbable">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#torrent2magnet" data-toggle="tab">torrent file</a></li>
						<li><a href="#magnet2torrent" data-toggle="tab">magnet link</a></li>
					</ul>
					<div class="tab-content">
						...
						<div class="tab-pane" id="magnet2torrent">
							<form class="form-search">
								<input type="text" id="magnet" name="magnet" class="span6" placeholder="paste magnet link here" /> 
